...
function renderTestSignals(d){
  ...
  if($('testHealth'))$('testHealth').textContent=`系統 ${healthText} · 最近掃描 ${scanSec==null?'—':scanSec+'秒前'} · 監控 ${Number(h.tracked||0)} · 共用快取已啟用`;
