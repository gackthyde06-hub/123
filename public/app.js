...
function renderPerformance(d){
  ...
  $('perfByTier').innerHTML=perfBreakHtml(sum.byTier);$('perfByRegime').innerHTML=perfBreakHtml(sum.byRegime);if($('perfByStrategy'))$('perfByStrategy').innerHTML=perfBreakHtml(sum.byStrategy);$('perfBySymbol').innerHTML=perfBreakHtml(sum.bySymbol);if($('perfShadowSummary'))$('perfShadowSummary').innerHTML=perfShadowSummaryHtml(d.shadowSummary);if($('perfShadowByTier'))$('perfShadowByTier').innerHTML=perfBreakHtml(d.shadowSummary?.byTier);if($('perfStateLearning'))$('perfStateLearning').innerHTML=perfLearningHtml(d.stateLearning);
