...
if (process.env.UNIT_TEST !== '1') {
  app.listen(PORT, () => {
    console.log(`Position Alert V10.2.5 SOLO MAX ENTRY SNAPSHOT HOTFIX started on ${PORT}`);
