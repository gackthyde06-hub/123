...
if (process.env.UNIT_TEST !== '1') {
  app.listen(PORT, () => {
    console.log(`Position Alert V10.2.6 SOLO MAX ACTUAL TRADE LEDGER started on ${PORT}`);
