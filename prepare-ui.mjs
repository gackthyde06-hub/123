...
import { patchUiPolishV26133 } from './ui-polish-v26133-patch.mjs';
...
html=html.replace(/<script\s+src=[\"']\/app\.js(?:\?[^\"']*)?[\"']><\/script>/i,'<script src=\"/app.js?v=1026133\"></script>');

const cssTags=[
  '<link rel="stylesheet" href="/system-growth.css?v=sg26133">',
  '<link rel="stylesheet" href="/premium-theme.css?v=sg26133">',
  '<link rel="stylesheet" href="/structure-engine-v2.css?v=sg26133">',
  '<link rel="stylesheet" href="/structure-learning-ui.css?v=sg26133">',
  '<link rel="stylesheet" href="/chart-ux-v262.css?v=sg26133">',
  '<link rel="stylesheet" href="/manual-mode-ui.css?v=sg26133">',
  '<link rel="stylesheet" href="/growth-abc-v264.css?v=sg26133">',
  '<link rel="stylesheet" href="/actual-trade-hub-v2613.css?v=sg26133">',
].join('\n');
const jsTags=[
  '<script defer src="/system-growth.js?v=sg26133"></script>',
  '<script defer src="/premium-theme.js?v=sg26133"></script>',
  '<script defer src="/structure-engine-v2-ui.js?v=sg26133"></script>',
  '<script defer src="/structure-learning-ui.js?v=sg26133"></script>',
  '<script defer src="/manual-mode-ui.js?v=sg26133"></script>',
  '<script defer src="/growth-abc-v264.js?v=sg26133"></script>',
  '<script defer src="/actual-trade-hub-v2613.js?v=sg26133"></script>',
].join('\n');
