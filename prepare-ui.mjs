...
const candidateLifecycle=await run('CandidateLifecycle','candidate-lifecycle-v2667-patch.mjs','patchCandidateLifecycleV2667');
...
if(!candidateRecall||!candidateNarrative||!candidateLifecycle||!notify||!ui||!runtime||!stable)throw new Error('V2.6.67 required control layer did not apply; refusing partial UI');
console.log('[v2667] READY '+results.join(' · '));
