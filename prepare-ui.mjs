...
const cssTag='<link rel="stylesheet" href="/system-growth.css?v=sg120">';
const jsTag='<script defer src="/system-growth.js?v=sg120"></script>';
...
console.log('[ui] system growth v1.2.0 ready');
